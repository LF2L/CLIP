...
| riteria |                                                           |
+=========+===========================================================+
| St      | To support the mission of the organization or association |
| rategic | innovation strategy                                       |
| &       |                                                           |
| S       |                                                           |
| ymbolic |                                                           |
| Goals   |                                                           |
+---------+-----------------------------------------------------------+
| Ec      | To generate added value for all the stakeholders          |
| osystem | involved, to create long-term engagement and              |
| A       | identification with the lab.                              |
| pproach |                                                           |
+---------+-----------------------------------------------------------+
| Real    | To capture or resemble real life environments (through    |
| Context | space, equipment or methodologies).                       |
| World   |                                                           |
+---------+-----------------------------------------------------------+
| User's  | To involve users in the different phases of innovation    |
| Invo    | cycle in which they can test, evaluate, contribute and    |
| lvement | co-create.                                                |
+---------+-----------------------------------------------------------+
| Culture | To build an identity and to grow a community of users     |
| and     | engaged and motivated with access to the laboratory.      |
| Co      |                                                           |
| mmunity |                                                           |
+---------+-----------------------------------------------------------+
| T       | To enhance teamwork in innovation, encouraging better     |
| eamwork | communication (physical or virtual), encourage formal and |
|         | informal social interaction and motivate staff.           |
+---------+-----------------------------------------------------------+
| L       | To estimate the length of the project as a whole (short,  |
| ifespan | mid or long-term).                                        |
+---------+-----------------------------------------------------------+
...
| teria |                                                              |
+=======+==============================================================+
| Int   | The intended role of the lab in supporting innovation        |
| ended | processes: Opportunity Identification, Concept Creation,     |
| Innov | Concept Validation, Solution Development, Solution           |
| ation | Deployment                                                   |
| Proc  |                                                              |
| esses |                                                              |
+-------+--------------------------------------------------------------+
| Int   | The intended role of the lab in supporting creative          |
| ended | activities: Search, synthesis, creation, prototyping or      |
| Cre   | evaluation.                                                  |
| ative |                                                              |
| Activ |                                                              |
| ities |                                                              |
+-------+--------------------------------------------------------------+
| Users | The intended users of the space: from occasional test users  |
| and   | or students through to dedicated environments for co-located |
| fa    | project teams. The degree of dedicated facilitation that the |
| cilit | lab is intended to provide for the activities performed      |
| ators | in/by the lab.                                               |
+-------+--------------------------------------------------------------+
| Avai  | The availability of physical, financial, human and technical |
| lable | resources.                                                   |
| reso  |                                                              |
| urces |                                                              |
| &     |                                                              |
...
| aints |                                                              |
+-------+--------------------------------------------------------------+
| Int   | The type of "events" that are expected to be held in the     |
| ended | space, ranging from one-off meetings, marathons, conferences |
| e     | or project work                                              |
| vents |                                                              |
+-------+--------------------------------------------------------------+
